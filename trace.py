...
class FunctionInterceptor:
    ...
    def __init__(self, include_file_fn=None, min_time_ms=10):
        self.call_stack: list[FunctionInterceptor.Record] = []
    ...
    def trace_calls(self, frame, event, arg):
        ...
        if event == 'call' and should_log:
            ...
            self.call_stack.append(FunctionInterceptor.Record(self.system_time(), func_name, filename, line_number))
            ...
            if self.call_stack and self.call_stack[-1].func_name == func_name:
                if int(self.system_time() * 1000 - self.call_stack[-1].start_s * 1000) >= min_time_ms:
                    ...
                    a = "| "
                    print(
                        f" > {int(self.system_time() * 1000 - self.call_stack[-1].start_s * 1000):>10} ms :: "
